    ...
    <script>
        @if (
            ...
            $(document).on("click", "#flutterwavePaymentBtn", function() {
                ...
                if (amount) {
                    var API_publicKey = '{{ $settings['flutterwave_public_key'] }}';
                    var nowTim = "{{ date('d-m-Y-h-i-a') }}";
                    var flutter_callback = "{{ url('subscription/flutterwave/') }}";
                    var x = getpaidSetup({
                ...
                @if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                                    ...
                                    <div class="setting-card action-menu">
                                        <div class="form-group">
                                            <div class="form-check custom-chek">
                                                ...
                                                <label class="form-check-label"
                                                    for="have_stripe_coupon">{{ __('Have a Discount
                                                                                            Coupon Code?') }}
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body profile-user-box">
                                <form
                                    action="{{ route('subscription.flutterwave', \Illuminate\Support\Facades\Crypt::encrypt($subscription->id)) }}"
                                    ...
                                    <div class="row">
                                        @if ($subscription->couponCheck() > 0)
                                            <div class="col-md-12 d-none coupon_div">
                                                <div class="form-group">
                                                    <label for="card-name-on"
                                                        class="form-label text-dark">{{ __('Coupon
                                                                                                    Code') }}</label>
                                                    <input type="text" name="coupon"
                                                        class="form-control required packageCouponCode"
                                                        placeholder="{{ __('Enter Coupon Code') }}">
                                        ...
                                        <div class="col-sm-12">
                                            @if ($subscription->couponCheck() > 0)
                                                <input type="button" value="{{ __('Coupon Apply') }}"
                                                    class="btn btn-warning packageCouponApplyBtn d-none coupon_div">
                                            @endif
                                            <input type="button" value="{{ __('Pay Now') }}" id="flutterwavePaymentBtn"
