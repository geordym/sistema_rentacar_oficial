        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-auto">
                            <?php echo e(Form::label('flutterwave_payment',__('Flutterwave Payment'),array('class'=>'form-label'))); ?>

                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-check custom-chek">
                                    <input class="form-check-input" type="checkbox" name="flutterwave_payment" id="flutterwave_payment" <?php echo e($settings['flutterwave_payment'] == 'on' ? 'checked' : ''); ?>>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('flutterwave_public_key',__('Flutterwave Public Key'),array('class'=>'form-label'))); ?>
                            ...
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('flutterwave_secret_key',__('Flutterwave Secret Key'),array('class'=>'form-label'))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u604031758/domains/peachpuff-wolf-941356.hostingersite.com/public_html/resources/views/settings/payment.blade.php ENDPATH**/ ?>