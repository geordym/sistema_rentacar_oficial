...
class PaymentController extends Controller
{
    ...
    public function subscriptionFlutterwave(Request $request, $id)
    {
        ...
        if ($price > 0) {
            ...
            $resData['currency'] = isset($paymentSetting['CURRENCY']) ? $paymentSetting['CURRENCY'] : 'USD';
            $resData['flag'] = 1;
            return $resData;
        } else {
    ...
    public function subscriptionFlutterwaveStatus(Request $request, $subscription_id, $pay_id)
    {
